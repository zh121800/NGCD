...
class CustomCIFAR100(CIFAR100):
    def __init__(self, root, transform=None, train=True, **kwargs):
        super(CustomCIFAR100, self).__init__(root=root, transform=transform, train=train, download=True, **kwargs)
        self.uq_idxs = np.array(range(len(self)))
