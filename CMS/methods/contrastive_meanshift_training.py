...
#这行代码计算了 features 中每个样本与 all_feats 中每个样本之间的点积相似度，
#返回一个形状为 (batch_size * n_views, total_samples) 的张量，表示当前批次样本与所有训练样本之间的相似度。
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_root', type=str, default='/home/beichen_zhang/zhenghao/cl/CMS/log')
